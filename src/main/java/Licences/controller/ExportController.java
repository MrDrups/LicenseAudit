...
public class ExportController {
    ...
    public ExportController(ExportService exportService, LicenseRepository licenseRepository,
                            CompanyRepository companyRepository, LicensePlanRepository licensePlanRepository,
